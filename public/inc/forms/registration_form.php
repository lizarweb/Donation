...
<div class="dnm-container">
	<div class="dnm-row">
		<div class="dnm-col-12">
			<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="dnm-save-custom-registration-form">
				<?php wp_nonce_field( 'dnm_save_custom_registration_form', 'nonce' ); ?>
				<input type="hidden" name="action" value="dnm_save_custom_registration_form">
