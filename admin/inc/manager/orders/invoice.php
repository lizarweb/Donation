						...
						<tbody>
							...
							<tr class="content">
								<td>
									...
									महाराणा प्रताप सिंह चौराहा, ग्राम सावल्दा, ता शिरपुर, जिला धुले, महाराष्ट्र 425405 <br>
								...
								<td class="font-weight-bold">
									...
									<!-- <?php echo $order_data['name']; ?> <br>Email: <?php echo $order_data['email']; ?> <br>Phone: <?php echo $order_data['phone']; ?> <br> <?php echo $order_data['address']; ?> -->
								</td>
							</tr>
						</tbody>
					</table>
